...
|      ingenuity       |  心灵手巧的  |           |         |
|   foresightedness    |   前瞻性   |           |         |
|   circumstantially   |  依照情况的  |           |         |
|      implicated      |  有牵连的   |           |         |
|         edge         |  优势、边   |           |         |
|       picture        |  局面、照片  |           |         |
|        demise        |  死亡、倒闭  |           |         |
|      tectonics       |  地质构造学  |           |         |
|   at the mercy of    |  受控制于   |           |         |
| too crippled to cope |  无力应付   |           |         |
|       metallic       |  金属制的   |           |         |
|    preferentially    |   优先的   |           |         |
|      meteorite       |   陨石    |           |         |
|       bombard        |   轰炸    |           |         |
...
|                      read                      |   explain   | listening | explain |
| :--------------------------------------------: | :---------: | :-------: | :-----: |
| earthenware / stoneware / porcelain -> ceramic | 陶/石/瓷器 ->陶瓷 |           |         |
|                      kiln                      |      窑      |           |         |
|                   delineate                    |     描述      |           |         |
|                     motif                      |     主旨      |           |         |
|                   instigate                    |    开始、煽动    |           |         |
...
|      |         |      craze       |     狂热     |
|      |         |  hand over fist  | 大量进行某种活动获利 |
|      |         |   flip through   |    快速翻阅    |
|      |         | counterintuitive |    反直觉的    |
|      |         |     criteria     |     标准     |
|      |         |  followed along  |   听从、理解    |
|      |         |      blurb       |     简介     |
|      |         |      booth       |     岗亭     |
|      |         |     tonality     |   音质、音调    |
|      |         |    legitimate    |    正当的     |
...
|      |         |     groundwork      |       基础       |
|      |         |      graduated      |   分等级的、大学毕业    |
|      |         |  run idea past sb.  |    向某人传达想法     |
|      |         |       arctic        |      北极的       |
|      |         |      insulated      | 有隔热（或隔音、绝缘）保护的 |
|      |         |        trek         |   （尤指徒步）长途跋涉   |
|      |         |         gel         |       凝胶       |
|      |         |        moss         |       苔藓       |
